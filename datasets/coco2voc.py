...
if __name__ == '__main__':
    coco_train_annotation_file = '/training_data_2/yuetian/OWOD/annotations/instances_train2017.json'
    coco_val_annotation_file = '/training_data_2/yuetian/OWOD/annotations/instances_val2017.json'
    target_folder = '/training_data_2/yuetian/OWOD'
